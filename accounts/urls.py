...
urlpatterns = [
    ...
    path(
        'pwd-reset/', 
        auth_views.PasswordResetView.as_view(success_url=reverse_lazy('accounts:pwd_reset_done')), 
        name='password_reset'
    ),
    path('pwd-reset/done', auth_views.PasswordResetDoneView.as_view(), name='pwd_reset_done'),
    path(
